...
- **Long work is a job**: songs, stems, karaoke, preparation, training. Start it, then
  `studio_wait` (a `job_id`, or `until: preparation | training | idle`) instead of
...
- **song**: create, job get/list/cancel, replay.
