    ...
    TOOLS.get_or_init(|| {
        vec![
            ...
            Tool {
                ...
                description: "The songs in the library, newest first: id, title, when made and the start of the caption. query filters by title or caption; library_song_get gives one song whole. response_format detailed gives every field of every song.",
            ...
            Tool {
                ...
                description: "One library song with its request, caption, lyrics and settings.",
                schema: || id_only("song_id", "library song id"),
